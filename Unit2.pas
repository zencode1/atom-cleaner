...
function GarbageCollectAtoms(Logs : TStrings; Clean : Boolean; CleanAll : Boolean = False) : Integer;
type
...
var
  ...
  countDelphiProcs : Integer;
  countActiveProcs : Integer;
  countRemovedProcs : Integer;
  countCantRemoveProcs : Integer;
  countUsedAtoms : Integer;
  countScannedAtoms : Integer;
  ...
  begin
    ...
    case isActive of
      ...
      begin
        ...
        if Clean and (not CleanAll) then
...
begin
  ...
  GarbageCollectAtoms(Memo1.Lines, True, CheckBox1.Checked);
end;
